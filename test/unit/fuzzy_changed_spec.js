...
describe('fuzzy', function() {
  ...
  describe('isMajorChange', function() {
    it('detects a single character changed with threshold=0', function() {
      const html1 = readFixtures('amo.html');
      const html2 = html1.slice(0, 1093) + 'd' + html1.slice(1094);
    ...
    using([
      ...
      it('returns ' + data.major + ' when ' + data.slice + ' characters are ' +
         'changed at start with threshold=' + data.threshold, function() {
        const html1 = readFixtures('amo.html');
        const html2 = Array(data.slice + 1).join('d') + html1.slice(data.slice);
    ...
    using([
      ...
      it('returns ' + data.major + ' when ' + data.slice + ' characters are ' +
         'changed at end with threshold=' + data.threshold, function() {
        const html1 = readFixtures('amo.html');
