...
pref("extensions.{c07d1a49-9894-49ff-a594-38960ede8fb9}.description", "chrome://updatescan/locale/updatescan.properties");

// Notification preferences
pref("extensions.updatescan.notifications.enable", true);
pref("extensions.updatescan.notifications.displayTime", 5);
pref("extensions.updatescan.notifications.permanent", false);
pref("extensions.updatescan.notifications.playSound", true);
pref("extensions.updatescan.notifications.defaultSound", true);
...
pref("extensions.updatescan.scan.enable", true);
